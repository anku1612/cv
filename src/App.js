        ...
        <header className='header'>
          <div className='container clearfix'>
            ...
            <div className='profile-content float-left'>
              <h1 className='name'>AKANKSHA SHARMA </h1>
            ...
            {/*//profile*/}
            <a
              className='btn btn-cta-primary float-right'
              href='http://github.com/anku1612'
              target='_blank'
            >
                ...
                <div className='section-inner'>
                  ...
                  <div className='content'>
                    <div className='item featured text-center'>
                      ...
                      <p className='summary'>
                        The perfect Bootstrap 4 admin template for app
                        developers
                      </p>
                      ...
                      <a
                        ...
                        target='_blank'
                      >
                        <i className='fas fa-thumbs-up' /> Back my project
                      </a>
                    </div>
                    {/*//item*/}
                      ...
                      <div className='desc col-md-8 col-12'>
                        <h3 className='title'>
                          <a
                            ...
                            target='_blank'
                          >
                            Instance - Bootstrap 4 Portfolio Theme for Aspiring
                      ...
                      <div className='desc col-md-8 col-12'>
                        <h3 className='title'>
                          <a
                            ...
                            target='_blank'
                          >
                            DevStudio - Bootstrap 4 Theme for WebDev Agencies
                      ...
                      <div className='desc col-md-8 col-12'>
                        <h3 className='title'>
                          <a
                            ...
                            target='_blank'
                          >
                            Nova Pro - Bootstrap 4 Theme for Mobile Startups
                          </a>
                        </h3>
                        <p className='mb-2'>
                          You can put one of your secondary projects here.
                      ...
                      <div className='desc col-md-8 col-12'>
                        <h3 className='title'>
                          <a
                            ...
                            target='_blank'
                          >
                            Delta - Bootstrap 4 Theme for Promoting Mobile Apps
                          </a>
                        </h3>
                        <p className='mb-2'>
                          {' '}
                ...
                <div className='section-inner'>
                  ...
                  <div className='content'>
                    <div className='item'>
                      <h3 className='title'>
                        <a
                          ...
                          target='_blank'
                        >
                          Pillar - Free Bootstrap 4 Resume/CV Template for
                          Developers
                        </a>{' '}
                    ...
                    <div className='item'>
                      <h3 className='title'>
                        <a
                          ...
                          target='_blank'
                        >
                          DevBlog - Free Bootstrap 4 Blog Template for
                          Developers
                        </a>{' '}
                        <span className='badge badge-theme'>Free</span>
                      </h3>
                    ...
                    <a className='btn btn-cta-secondary' href='#'>
                      More on CoderWall <i className='fas fa-chevron-right' />
                    </a>
                  </div>
                  {/*//content*/}
                </div>
                  ...
                  <div className='content'>
                    <ul className='list-unstyled'>
                      <li>
                        ...
                        <span className='sr-only'>Location:</span>Raipur
                        Chhattisgarh, India
                      </li>
                      <li>
                        <i className='fas fa-envelope' />
                        <span className='sr-only'>Email:</span>
                        <a href='#'>sharmaanku908@gmail.com</a>
                      </li>
                      <li>
                ...
                <div className='section-inner'>
                  ...
                  <div className='content'>
                    <p className='intro'>
                      ...
                      link to your Linkedin or Coderwall profile so people can
                      get more info there.
                    </p>
                    ...
                    <div className='item'>
                      <blockquote className='quote'>
                        <p>
                          ...
                          James is an excellent software engineer and he is
                          passionate about what he does. You can totally count
                          on him to deliver your projects!
                        </p>
                      </blockquote>
                      <p className='source'>
              ...
              <aside className='education aside section'>
                <div className='section-inner'>
                  ...
                  <div className='content'>
                    <div className='item'>
                      <h3 className='title'>
                        <i className='fas fa-graduation-cap' /> MSc Computer
                        Science
                      </h3>
                    ...
                    <div className='item'>
                      <h3 className='title'>
                        <i className='fas fa-graduation-cap' /> BSc Computer
                        Science
                      </h3>
                      <h4 className='university'>
                        University of Bristol{' '}
                        <span className='year'>(2008-2011)</span>
                      </h4>
                    </div>
                    {/*//item*/}
                  </div>
                  ...
                  <div className='content'>
                    <ul className='list-unstyled pb-2'>
                      ...
                      <li>
                        Profile image:{' '}
                        <a
                          href='https://www.flickr.com/photos/dotbenjamin/2577394151'
                          target='_blank'
                        >
                          Ben Smith
                        </a>
                    ...
                    <hr />
                    <p className='pt-2'>
                      This Bootstrap 4 portfolio template is handcrafted by UX
                      designer{' '}
                      <a
                      ...
                      for developers and is <strong>FREE</strong> under the{' '}
                      <a
                    ...
                    <a
                      ...
                      target='_blank'
                    >
                      <i className='fas fa-download' /> I want to download
                    </a>
                    <hr />
                    ...
                    <a
                      ...
                      target='_blank'
                    >
                      <i className='fab fa-twitter' /> Follow on twitter
                    </a>
                  </div>
                  {/*//content*/}
                </div>
